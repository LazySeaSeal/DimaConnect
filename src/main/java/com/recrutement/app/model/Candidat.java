...
public class Candidat {
    ...
    // Ajouté : relations pour les contacts envoyés et reçus
    @OneToMany(mappedBy = "sender")
    private Set<ContactCandidat> contactsEnvoyes = new HashSet<>();

    @OneToMany(mappedBy = "receiver")
    private Set<ContactCandidat> contactsRecus = new HashSet<>();
}
