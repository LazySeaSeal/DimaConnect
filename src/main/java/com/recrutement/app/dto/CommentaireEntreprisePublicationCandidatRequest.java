...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Requête pour créer un commentaire d'entreprise sur une publication de candidat")
public class CommentaireEntreprisePublicationCandidatRequest {
