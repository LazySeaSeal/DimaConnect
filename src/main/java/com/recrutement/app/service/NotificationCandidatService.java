...
import com.recrutement.app.model.enums.StatutContact; // Import for StatutContact
import com.recrutement.app.model.enums.TypeNotification;
import com.recrutement.app.repository.ContactCandidatRepository; // Import for ContactCandidatRepository
...
public class NotificationCandidatService {
    ...
    @Autowired
    private ContactCandidatRepository contactCandidatRepository; // Added missing repository
    ...
    public NotificationCandidat acceptContactAndCreateNotification(Long contactId) {
        // 1. Update contact status to ACCEPTED
        ...
        if (contact.getStatut() != StatutContact.DEMANDE) {
            throw new IllegalStateException("Contact is not in DEMANDE status");
        }
        ...
        // 2. Create acceptance notification
        NotificationCandidat notification = new NotificationCandidat();
