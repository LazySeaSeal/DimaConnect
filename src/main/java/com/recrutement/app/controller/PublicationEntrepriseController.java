...
public ResponseEntity<?> createPublication(
    ...
    try {
        ...
        request.setOwnerId(entrepriseId); // Assigner l'ID du entreprise

        PublicationEntreprise publication = publicationService.createPublication(request);
    ...
    // Récupérer toutes les publications d'un entreprise
    @GetMapping("/entreprise/{entrepriseId}")
    public ResponseEntity<?> getPublicationsByEntreprise(@PathVariable Long entrepriseId) {
        try {
            List<PublicationEntreprise> publications = publicationService.getPublicationsByEntrepriseId(entrepriseId);
    ...
    public ResponseEntity<?> getPublicationById(@PathVariable Long id) {
        try {
            PublicationEntreprise publication = publicationService.getPublicationById(id);
    ...
    public ResponseEntity<?> updatePublication(@PathVariable Long id, @RequestBody PublicationRequest request) {
        try {
            PublicationEntreprise updatedPublication = publicationService.updatePublication(id, request);
    ...
    public ResponseEntity<?> addLike(@PathVariable Long id) {
        try {
            PublicationEntreprise publication = publicationService.addLike(id);
    ...
    public ResponseEntity<?> removeLike(@PathVariable Long id) {
        try {
            PublicationEntreprise publication = publicationService.removeLike(id);
